...
(http://godoc.org/github.com/sectoken-dev/godashutil/bloom)
...
```bash
$ go get -u github.com/sectoken-dev/godashutil/bloom
```

## Examples

* [NewFilter Example]
  (http://godoc.org/github.com/sectoken-dev/godashutil/bloom#example-NewFilter)  
